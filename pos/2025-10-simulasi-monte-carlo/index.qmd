...
3.  Menggunakan `annotate()` untuk membuat representasi sebuah jarum sebagai sebuah ruas garis (`geom = "segment"`), yang ujung-ujungnya di $\left( x_{1}, y_{1} \right)$ dan $\left( x_{2}, y_{2} \right)$ (`x = x_1, xend = x_2, y = y_1, yend = y_2`), berwarna biru (`color = "#4269d0"`), dan tebalnya 1,5 (`linewidth = 1.5`).
