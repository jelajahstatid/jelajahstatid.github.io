...
Berdasarkan @fig-jarum-dan-garis, kita dapat melihat bahwa jarum yang memotong garis nilai $\frac{1}{2}l\sin\left(\theta\right)$ lebih dari jarak vertikal titik tengahnya dengan garis horizontal terdekat.
...
hasil_eksperimen <- data_eskperimen |> 
  ggplot() + 
  geom_hline(
    yintercept = 0:10,
    color = "gray80",
