...
-   jika tanda-tanda panahnya searah, variabel-variabel yang direpresentasikannya memiliki korelasi yang positif;

-   jika berlawanan arah, variabel-variabelnya berkorelasi negatif; dan

-   jika tegak lurus, variabel-variabelnya tidak berkorelasi.
...
-   Rata-rata konsumsi pangan Provinsi Kalimantan Tengah pada tahun 2018 di kategori `Pangan Hewani` dan `Gula` lebih besar dari provinsi-provinsi lainnya.

-   Rata-rata konsumsi pangan Provinsi Papua pada tahun 2023 di kategori `Umbi-umbian` lebih besar dari provinsi-provinsi lainnya. Berdasarkan @fig-aku-grup, hal ini juga terjadi untuk tahun-tahun 2018, 2019, 2021, dan 2024.
