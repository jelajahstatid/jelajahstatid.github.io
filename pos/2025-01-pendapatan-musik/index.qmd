...
::: {#fig-obs-input-plot .column-page}
```{ojs}
//| panel: sidebar
//| echo: false
...
viewof tahun1 = Inputs.range([1973, 2023], {value: 1973, step: 1, label: "Year (batas 1)"})
viewof tahun2 = Inputs.range([1973, 2023], {value: 2023, step: 1, label: "Year (batas 2)"})
```
...
Diagram yang dibuat dengan Plot Observable dan disertai dengan beberapa input
:::
