---
title: "Indonesia Negara Dua Musim: Bagaimana Curah Hujannya?"
...
Sekarang kita buat sebuah SpatRaster dari fail "mswep_tp_mm_global_197902_202301_025_monthly.nc" dengan menggunakan fungsi `rast()` dari {terra}. Setelah itu, kita potong hasilnya dengan `sf_negara` menggunakan fungsi `crop()` dari {terra}. Kita namai hasilnya sebagai `data_mswep` dan kita cetak objek tersebut dengan menggunakan fungsi `print()`.
